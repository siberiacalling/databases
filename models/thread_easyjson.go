...
func easyjson2d00218DecodeDbForumModels(in *jlexer.Lexer, out *Thread) {
...
func easyjson2d00218EncodeDbForumModels(out *jwriter.Writer, in Thread) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Thread) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2d00218EncodeDbForumModels(&w, v)
...
func (v *Thread) UnmarshalJSON(data []byte) error {
	...
	easyjson2d00218DecodeDbForumModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Thread) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2d00218DecodeDbForumModels(l, v)
}
