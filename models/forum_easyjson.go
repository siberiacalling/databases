...
func easyjsonC8d74561DecodeDbForumModels(in *jlexer.Lexer, out *Forum) {
...
func easyjsonC8d74561EncodeDbForumModels(out *jwriter.Writer, in Forum) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Posts != 0 {
...
func (v Forum) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC8d74561EncodeDbForumModels(&w, v)
...
func (v *Forum) UnmarshalJSON(data []byte) error {
	...
	easyjsonC8d74561DecodeDbForumModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Forum) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC8d74561DecodeDbForumModels(l, v)
}
